...
module.exports = AmazonDb = function(options) {
  var DynamoDB, S3, db, k, operations_ro_queue, operations_rw_queue, operations_table, s3, s3_ro_queue, s3_rw_queue, snapshots_bucket, snapshots_ro_queue, snapshots_rw_queue, snapshots_table, v;
